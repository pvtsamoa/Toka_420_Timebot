# Toka 420 Time Bot — Deployment Guide
...
2. **TELEGRAM_GLOBAL_CHAT_ID** — Chat ID where rituals will be posted
   ```bash
...
- `media/jokes.json` — Humor
- `media/safety.json` — Safety tips
- `media/proverbs.json` — Wisdom
- `media/market.json` — Market tips
