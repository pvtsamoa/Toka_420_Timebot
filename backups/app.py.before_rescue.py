...
from commands import setchat, ritual
...
from telegram.ext import Application, CommandHandler, CommandHandler, CommandHandler, ContextTypes
...
def build_app() -> Application:
    app = Application.builder().post_init(on_startup).build()
    ...
    schedule_hubs(app)
    print('🗓️  Scheduler wired: schedule_hubs(app)')
